  ...
  return (
    <div className="">
        <div className="grid grid-cols-2 w-screen h-[calc(100vh-70px)] bg-true-black bg-[url('/homepage1.png')] bg-no-repeat bg-[length:60%_auto] bg-left relative">
            ...
            <div className="flex flex-col col-span-1 bg-true-black rounded-bl-[60px] justify-center items-center p-10">
                <div className="flex flex-col gap-4 w-1/2 text-left">
                    <div className="text-4xl"><span className="text-red">Portman.</span> A new approach to investing.</div>
                ...
                <div className="mt-8 flex justify-center w-full">
                    <Card className="bg-red text-white p-6 rounded-lg no-border w-1/2 mt-10">
                        <CardHeader>
                            <CardTitle className="text-xl text-true-black font">Wealth Starts Here.</CardTitle>
                            <CardTitle className="text-lg text-white">Start now.</CardTitle>
                        </CardHeader>
                        <CardContent className="flex items-center gap-4">
                            <Button className="bg-black text-white"  onClick={() => router.push("/auth/login")}>Log in</Button>
                            <div>or</div>
                            <Button className="bg-black text-white" onClick={() => router.push("/auth/register")}>Create new account</Button>
                        </CardContent>
                    </Card>
                </div>
            </div>
        ...
        <div className="flex flex-col items-center">
            <div className="text-lg text-red font-bold p-4 mt-6">Why choose Portman?</div>
            ...
            <div className="text-lg text-red font-bold p-4 mt-6">How Portman Helps you invest</div>
            ...
            <div className="text-lg text-red font-bold p-4 mt-6">3 Easy steps to get you started</div>
            <div className="grid grid-cols-3 grid-rows-1 gap-4 w-2/3 mb-16">
                <Card className="bg-true-black hover:border-red">
                    ...
                    <CardContent className="h-auto">
                        ...
                        <Image src="/homepage1.png" alt="Description of image" className="w-85 h-auto" />
                    </CardContent>
                </Card>
