...
export default function Page()
{
    ...
    const [searchResults, setSearchResults] = useState<{_id: string; symbol: string; name: string; currency: string;}[]>([]);
    const [selectedAsset, setSelectedAsset] = useState<{_id: string; symbol: string; name: string; currency: string;} | null>(null);
    const [isPortfolioOwner, setIsPortfolioOwner] = useState<boolean | null>(null);
        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div>
                    ...
                    />
                    {errors.price_per_unit && <p className="text-red-500">{errors.price_per_unit.message}</p>}
                </div>
